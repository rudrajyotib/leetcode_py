...
public class LeetCode743Test
{
	...
	{
		assertEquals(-1, LeetCode743.networkDelayTimeViaDijkstra(new int[][]{{2,1,1},{2,3,1},{3,4,1}}, 4, 1));
		assertEquals(-1, LeetCode743.networkDelayTimeViaDijkstra(new int[][]{{1,2,1},{2,3,2},{1,3,1}}, 3, 2));
